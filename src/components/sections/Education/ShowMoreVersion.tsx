...
export default function EducationSectionShowMore() {
  const { setHovered, clearHovered, isHovered, isDimmed } = useHoverGroup();

  return (
    <MotionSection className="space-y-8">
      <ShowMore title="Education & Certifications" defaultShow={true} maxHeight="150px">
      ...
      <ShowMore title="Awards & Recognition" maxHeight="120px">
        <div className="space-y-3">
